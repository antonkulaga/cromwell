...
//}
//
//// FIXME: This should go away (cut over tests)
...
//  /**
//    *
//    * onMalformed: workflowID is not a UUID
//    * onFailure: Failed to look up in the DB
//    * onUnrecognized: WorkflowId not in DB
//    * onRecognized: WorkflowId is in DB
//    *
//    * Workflow ID lookup is in MetadataService. Transform this to an ask w/ appropriate handling
//    */
//
